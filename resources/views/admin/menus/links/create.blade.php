...
<form action="{{ route('menulink.store', $menu) }}" method="POST" role="form">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group @if($errors->has("text")) has-error @endif">
                      ...
                      <input type="text" class="form-control" name="text" id="text" value="{{ old("text") }}" placeholder="Link Text">
                    </div>
                    ...
                    <div class="form-group @if($errors->has("link")) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="link" id="link" value="{{ old("link") }}" placeholder="Link URL">
                    </div>
                    ...
                    <div class="form-group @if($errors->has("order")) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="order" id="order" value="{{ old("order") }}" placeholder="Link Order">
                    </div>
